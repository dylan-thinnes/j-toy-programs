...
rgb_ansi =: 48 2 ,"1 ]
convert_grey_ansi =: [: rgb_ansi [: <. 255 255 255 *"1 0 [] 1 <. 0 >. ]

NB. turns hue angle in % of circle to rgb, assuming 100% brightness and saturation
NB. convert_hue_ansi excludes values gt 1
cxooxc =: 0 >. 1 <. 6 * (1%6) -~ [: (**) 0.5 -~ ]
rgb =: ([: cxooxc 1 | (0 _1 1 % 3) + ])"0
rgbi =: [: <. 255 * rgb
convert_hue_ansi =: (1 > ]) * [: rgb_ansi [: rgbi 1 <. ]

rainbow_square =: convert_hue_ansi 25 %~ i. 5 5
true_rainbow_arch =: convert_hue_ansi 60 %~ %: (+&:*:)"0/~ i: 60
